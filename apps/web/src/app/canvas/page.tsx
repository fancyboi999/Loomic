...
function CanvasPageContent() {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      {!ws.connected && (
        <div className="absolute top-0 left-0 right-0 z-50 flex items-center justify-center gap-2 bg-amber-50 border-b border-amber-200 px-4 py-1.5 text-xs text-amber-700">
